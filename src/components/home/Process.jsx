...
//       <div className="prc-container">
//         {/* Header */}
//         <div className={`prc-header ${prcVisible ? 'prc-header--visible' : ''}`} style={{ transform: `translateY(${prcScrollY * -0.03}px)` }}>
//           <span className="prc-header__tag">Engineering Process</span>
//           <h2 className="prc-header__title">
//             Our Proven RF Engineering
//             <span className="prc-header__accent"> Deployment Process</span>
...
//         <div className={`prc-stepper ${prcVisible ? 'prc-stepper--visible' : ''}`}>
//           {prcSteps.map((step, index) => (
//             <button
//               key={step.id}
...
//           >
//             <div className="prc-display__left">
//               <div className="prc-display__icon-wrap" style={{ background: prcSteps[prcActiveStep].bgLight, color: prcSteps[prcActiveStep].color }}>
//                 {prcSteps[prcActiveStep].icon}
//               </div>
//               <div className="prc-display__step-num" style={{ color: prcSteps[prcActiveStep].color }}>
//                 Step {prcSteps[prcActiveStep].id}
//               </div>
//             </div>
//             <div className="prc-display__right">
//               <h3 className="prc-display__title">{prcSteps[prcActiveStep].title}</h3>
//               <p className="prc-display__desc">{prcSteps[prcActiveStep].description}</p>
...
//                   />
//                 </div>
//                 <span className="prc-display__progress-text" style={{ color: prcSteps[prcActiveStep].color }}>
//                   {prcActiveStep + 1} of {prcSteps.length} — {prcActiveStep < prcSteps.length - 1 ? 'In Progress' : 'Complete'}
//                 </span>
//               </div>
//             </div>
//           </div>
...
//             onClick={() => setPrcActiveStep((prev) => (prev > 0 ? prev - 1 : prcSteps.length - 1))}
//             disabled={prcActiveStep === 0}
//           >
...
//           <button
//             className="prc-nav__btn"
//             onClick={() => setPrcActiveStep((prev) => (prev < prcSteps.length - 1 ? prev + 1 : 0))}
//             disabled={prcActiveStep === prcSteps.length - 1}
//           >
...
//         {/* Bottom CTA */}
//         <div className={`prc-cta ${prcVisible ? 'prc-cta--visible' : ''}`} style={{ transform: `translateY(${prcScrollY * -0.01}px)` }}>
//           <div className="prc-cta__card">
//             <div className="prc-cta__content">
//               <h3 className="prc-cta__title">Let's Design the Right Mobile Signal Solution for Your Building</h3>
//               <p className="prc-cta__desc">
//                 Our RF engineers will analyze your site, recommend the optimal i Booster or DAS 
//                 configuration, and deliver end-to-end implementation with professional installation 
//                 and ongoing technical support.
...
import surveyImg from "../../assets/hero1.png";
import planningImg from "../../assets/hero1.png";
import designImg from "../../assets/hero1.png";
import installImg from "../../assets/hero1.png";
