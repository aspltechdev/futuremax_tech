        ...
        <div className="prd-container">
          <div className={`prd-hero__content ${prdVisible.hero ? 'prd-hero__content--visible' : ''}`} data-prd-section="hero">
            ...
            <p className="prd-hero__desc">
             Explore 33+ cellular coverage products, including smart commercial repeaters, single-band, dual-band, and tri-band mobile signal boosters, indoor and outdoor antennas, low-loss coaxial cables, and N-type RF connectors. Serving customers across Kerala, including Trivandrum, Kochi, Kozhikode, and Palakkad, we deliver high-performance RF solutions for reliable and seamless mobile connectivity.
            </p>
          ...
          >
            ...
            <div className="prd-cta__actions">
              ...
              <div className="prd-cta__contact">
               <a href="tel:+918848749897" className="prd-cta__contact-link">
  <Phone size={14} />
  +91 88487 49897
</a>
<a href="mailto:futuremaxtech@hotmail.com" className="prd-cta__contact-link">
  <Mail size={14} />
