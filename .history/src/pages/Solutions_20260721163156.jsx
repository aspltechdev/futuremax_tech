        ...
        <div className="sol-container">
          <div className={`sol-hero__content ${solVisible.hero ? 'sol-hero__content--visible' : ''}`} data-sol-section="hero">
            ...
            <p className="sol-hero__desc">
              ...
              technical support across India.Our RF engineering solutions power seamless mobile connectivity for customers across Kerala, including Trivandrum, Kochi, Kozhikode, and Palakkad.
            </p>
        ...
        <div className="sol-container">
          <div className={`sol-grid__header ${solVisible.solutions ? 'sol-grid__header--visible' : ''}`} data-sol-section="solutions">
            ...
            <p className="sol-grid__desc">
              ...
              educational campuses, factories, and large enterprise environments.Serving Trivandrum, Kochi, Kozhikode, Palakkad, and other major cities across Kerala, we provide high-performance RF solutions for uninterrupted mobile connectivity.
            </p>
          </div>
