        ...
        <div className="tgy-container">
          <div className={`tgy-hero__content ${tgyVisible.hero ? 'tgy-hero__content--visible' : ''}`} data-tgy-section="hero">
            ...
            <p className="tgy-hero__desc">
              ...
              using i Booster Series, Distributed Antenna Systems (DAS), and enterprise wireless solutions.Trusted by customers across Kerala, including Trivandrum, Kochi, Kozhikode, and Palakkad, we provide high-performance RF solutions for reliable and seamless mobile connectivity.
            </p>
          ...
          <div className={`tgy-cta__card ${tgyVisible.cta ? 'tgy-cta__card--visible' : ''}`} data-tgy-section="cta" style={{ transform: `translateY(${tgyScrollY * -0.01}px)` }}>
            ...
            <div className="tgy-cta__actions">
              ...
              <div className="tgy-cta__contact">
                <a href="tel:+919876543210" className="tgy-cta__contact-link"><Phone size={14} />94478671740</a>
