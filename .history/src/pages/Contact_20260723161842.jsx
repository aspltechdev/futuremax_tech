...
const WEB3FORMS_ACCESS_KEY = "1024e8c4-fc70-418f-abe5-ea0d72a8c51c";
...
const cntInfo = [
  {
    ...
    title: "Call Us",
    details: [
      { label: "Sales & Support", value: "+91 88487 49897"},
      { label: "Technical Support", value: "+91 94478 67174"}
    ],
    accentColor: "#0755A3",
  },
  {
...
const Contact = () => {
  ...
  const [cntSubmitting, setCntSubmitting] = useState(false);
  ...
  const handleCntSubmit = async (e) => {
    e.preventDefault();
    setCntError("");
    setCntSubmitting(true);

    try {
      const payload = {
        access_key: WEB3FORMS_ACCESS_KEY,
        subject: `New Inquiry from ${cntFormData.name} - Futuremax Technology`,
        from_name: "Futuremax Technology Website",
        name: cntFormData.name,
        email: cntFormData.email,
        phone: cntFormData.phone,
        company: cntFormData.company,
        service: cntFormData.service || "Not specified",
        message: cntFormData.message,
      };
      ...
      if (result.success) {
        ...
        setCntError(result.message || "Something went wrong. Please try again.");
      }
    } catch (err) {
      setCntError("Unable to send message. Please check your connection and try again.");
    } finally {
      setCntSubmitting(false);
    }
  };
        ...
        <div className="cnt-container">
          <div className={`cnt-hero__content ${cntVisible.hero ? 'cnt-hero__content--visible' : ''}`} data-cnt-section="hero">
            ...
            <div className="cnt-hero__actions">
              <a href="tel:+918848749897" className="cnt-hero__btn cnt-hero__btn--primary"><Phone size={16} /><span>+91 88487 49897</span></a>
              ...
              <div className="cnt-quick-contact">
                <div className="cnt-quick-contact__item">
                  ...
                  <div>
                    ...
                    <span className="cnt-quick-contact__value">+91 88487 49897</span>
                  </div>
                </div>
                <div className="cnt-quick-contact__item">
                  <Mail size={16} />
              ...
              <div className="cnt-form-right__card">
                {cntSubmitted ? (
                  ...
                  <form className="cnt-form-modern" onSubmit={handleCntSubmit}>
                    {cntError && (
                      <div className="cnt-form-modern__error">
                        <AlertCircle size={16} />
                        <span>{cntError}</span>
                      </div>
                    )}
                    ...
                    <button type="submit" className="cnt-form-modern__btn" disabled={cntSubmitting}>
                      {cntSubmitting ? (
                        <>
                          <Loader2 size={16} className="cnt-form-modern__spinner" />
                          <span>Sending...</span>
                        </>
                      ) : (
                        <>
        ...
        <div className="cnt-container">
          <div className="cnt-bottom__grid">
            ...
            <div className="cnt-bottom__card cnt-bottom__card--dark">
              ...
              <a href="tel:+919447867174" className="cnt-bottom__dark-btn">
                <Phone size={16} />
                <span>+91 94478 67174</span>
              </a>
            </div>
          </div>
        </div>
