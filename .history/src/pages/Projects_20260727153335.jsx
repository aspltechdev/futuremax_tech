...
const Projects = () => {
  ...
  const prjStats = [
    ...
    { icon: <Building2 size={24} strokeWidth={1.5} />, value: "2+", label: "Industries Served" },
        ...
        <div className="prj-container">
          <div className={`prj-hero__content ${prjVisible.hero ? 'prj-hero__content--visible' : ''}`} data-prj-section="hero">
            ...
            <p className="prj-hero__desc">
              ...
              and enterprise campuses.Serving Trivandrum, Kochi, Kozhikode, Palakkad, and other major cities across Kerala, we provide high-performance RF solutions for uninterrupted mobile connectivity.
            </p>
          ...
          <div className={`prj-cta__card ${prjVisible.cta ? 'prj-cta__card--visible' : ''}`} data-prj-section="cta" style={{ transform: `translateY(${prjScrollY * -0.01}px)` }}>
            ...
            <div className="prj-cta__actions">
              ...
              <div className="prj-cta__contact">
               <a href="tel:+918848749897" className="prj-cta__contact-link"><Phone size={14} />+91 88487 49897</a>
<a href="mailto:futuremaxtech@hotmail.com" className="prj-cta__contact-link"><Mail size={14} />futuremaxtech@hotmail.com</a>
              </div>
            </div>
          </div>
        </div>
