        ...
        <div className="tgy-container">
          <div className={`tgy-hero__content ${tgyVisible.hero ? 'tgy-hero__content--visible' : ''}`} data-tgy-section="hero">
            ...
            <p className="tgy-hero__desc">
              ...
              using i Booster Series, Distributed Antenna Systems (DAS), and enterprise wireless solutions.Trusted by customers across Kerala, including Trivandrum, Kochi, Kozhikode, and Palakkad, we provide high-performance 
              RF solutions for reliable and seamless mobile connectivity.
            </p>
