          ...
          <div className={`tgy-cta__card ${tgyVisible.cta ? 'tgy-cta__card--visible' : ''}`} data-tgy-section="cta" style={{ transform: `translateY(${tgyScrollY * -0.01}px)` }}>
            ...
            <div className="tgy-cta__actions">
              ...
              <div className="tgy-cta__contact">
                <a href="tel:+918848749897" className="tgy-cta__contact-link"><Phone size={14} />+91 88487 49897</a>
                <a href="mailto:futuremaxtech@hotmail.com" className="tgy-cta__contact-link"><Mail size={14} />futuremaxtech@hotmail.com</a>
              </div>
            </div>
          </div>
        </div>
