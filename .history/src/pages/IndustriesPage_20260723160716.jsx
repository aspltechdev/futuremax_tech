        ...
        <div className="ind-container">
          <div className={`ind-hero__content ${indVisible.hero ? 'ind-hero__content--visible' : ''}`} data-ind-section="hero">
            ...
            <p className="ind-hero__desc">
              ...
              and public infrastructure across India.Delivering reliable RF engineering solutions across Kerala, including Trivandrum, Kochi, Kozhikode, and Palakkad, we ensure seamless mobile connectivity for every environment.
            </p>
        ...
        <div className="ind-container">
          <div className={`ind-cta__card ${indVisible.cta ? 'ind-cta__card--visible' : ''}`} data-ind-section="cta" style={{ transform: `translateY(${indScrollY * -0.01}px)` }}>
            ...
            <div className="ind-cta__actions">
             ...
             <a href="tel:+918848749897" className="ind-cta__contact-link"><Phone size={14} />+91 88487 49897</a>
<a href="mailto:futuremaxtech@hotmail.com" className="ind-cta__contact-link"><Mail size={14} />futuremaxtech@hotmail.com</a>
              </div>
            </div>
          </div>
        </div>
