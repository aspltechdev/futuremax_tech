        ...
        <div className="prd-container">
          <div className={`prd-hero__content ${prdVisible.hero ? 'prd-hero__content--visible' : ''}`} data-prd-section="hero">
            ...
            <p className="prd-hero__desc">
              Explore 33 cellular coverage products including smart commercial repeaters, single-band, dual-band and tri-band boosters, indoor and outdoor antennas, low-loss coaxial cables and N-type RF connectors.With a strong presence across Kerala, including Trivandrum, Kochi, Kozhikode, and Palakkad, we deliver high-performance RF solutions for reliable mobile connectivity.
            </p>
