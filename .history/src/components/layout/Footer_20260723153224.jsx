...
const Footer = () => {
  ...
  const ftrSocialLinks = [
    ...
    { icon: <FaInstagram />, href: "https://www.instagram.com/futuremaxtech/", label: "Instagram" },
    { icon: <FaFacebookF />, href: "https://www.facebook.com/share/1GhcCFhBa9/", label: "Facebook" },
          ...
          <div className="ftr-grid">
            ...
            <div className="ftr-col ftr-col--contact">
              ...
              <div className="ftr-contact">
               ...
               <div className="ftr-contact__item">
  <span className="ftr-contact__icon" style={{ display: "inline-block", width: 18, height: 18 }}></span>
  <a href="tel:+918848749897"> +91 94478 67174</a>
</div>
                <div className="ftr-contact__item">
