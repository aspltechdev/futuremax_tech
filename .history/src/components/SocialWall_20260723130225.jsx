...
import socialWallBg from "../assets/orchestra.png";

/* =========================================================
   INSTAGRAM POSTS
========================================================= */
const instagramPosts = [
  "https://www.instagram.com/reel/DNFIYY-yN5M/",
  "https://www.instagram.com/reel/DZW2hm8TFbT/",
  "https://www.instagram.com/reel/C6YcEYgBCfN/",
  "https://www.instagram.com/reel/CvWoM3iNAAJ/",
];

/* =========================================================
   YOUTUBE VIDEOS — just video IDs
========================================================= */
const youtubeVideos = [
  "n7nXPM3i-fo",
  "gHnWS6BttdQ",
...
/* =========================================================
   HELPER: fill loop so marquee always has enough cards
========================================================= */
const fillLoop = (arr) => {
    ...
    >
        ...
        <div className="sw-header">
          ...
          <div className="sw-header-music-bg" aria-hidden="true">
            <svg
              ...
              className="sw-header-svg"
            >
              {/* Staff Lines */}
              <path
                d="M-20,90 Q200,50 400,90 T820,90"
                fill="none"
                stroke="rgba(201, 160, 61, 0.35)"
                strokeWidth="1.5"
              />
              <path
                d="M-20,100 Q200,60 400,100 T820,100"
                fill="none"
                stroke="rgba(201, 160, 61, 0.35)"
                strokeWidth="1.5"
              />
              <path
                d="M-20,110 Q200,70 400,110 T820,110"
                fill="none"
                stroke="rgba(201, 160, 61, 0.35)"
                strokeWidth="1.5"
              />
              <path
                d="M-20,120 Q200,80 400,120 T820,120"
                fill="none"
                stroke="rgba(201, 160, 61, 0.35)"
                strokeWidth="1.5"
              />
              <path
                d="M-20,130 Q200,90 400,130 T820,130"
                fill="none"
                stroke="rgba(201, 160, 61, 0.35)"
                strokeWidth="1.5"
              />
          ...
          <h2 className="sw-title">
            <span className="sw-title-light">Live From</span>
            <span className="sw-title-gold"> The Stage</span>
          </h2>
          ...
          <p className="sw-subtitle">
            Explore behind-the-scenes moments, live performances, artist
            spotlights and concert highlights from Meha SRUTHI&apos;s world.
          </p>
          ...
          <div className="sw-tabs">
            <button
              id="sw-tab-instagram"
              className={`sw-tab-btn ${
                activeTab === "instagram" ? "sw-tab-active" : ""
              }`}
            ...
            <button
              id="sw-tab-youtube"
              className={`sw-tab-btn ${
                activeTab === "youtube" ? "sw-tab-active" : ""
              }`}
            ...
            {/* LinkedIn tab — uncomment when available
            <button
              id="sw-tab-linkedin"
              className={`sw-tab-btn ${
                activeTab === "linkedin" ? "sw-tab-active" : ""
              }`}
            ...
            */}
            ...
            {/* Facebook tab — uncomment when available
            <button
              id="sw-tab-facebook"
              className={`sw-tab-btn ${
                activeTab === "facebook" ? "sw-tab-active" : ""
              }`}
      ...
      <div className="sw-marquee">
        <div className="sw-track">
          ...
          {/* LinkedIn cards — uncomment when available
          {activeTab === "linkedin"
          ...
          */}
          ...
          {/* Facebook cards — uncomment when available
          {activeTab === "facebook"
      ...
      <div className="sw-footer">
        ...
        <a
          href={
            activeTab === "instagram"
              ? "https://www.instagram.com/mehasruthi.entertainers/"
              : "https://www.youtube.com/channel/UCNnL1Cd9xrR6YDFqiqB7R9A"
          }
          target="_blank"
          rel="noreferrer"
        ...
        >
          ...
          {activeTab === "youtube" && <FaYoutube size={16} />}
          Check us on{" "}
