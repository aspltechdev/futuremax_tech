...
const Hero = () => {
  ...
  const slides = [
    {
      ...
      featuredProductLink: "/products", // link for the main showcase image
      products: [
    ...
    },
    {
      ...
      featuredProductLink: "/products/23-dbm",
      products: [
        { name: "i Booster 23", power: "23 dBm", type: "Residential", coverage: "300 m²", color: "#55C45C" },
        { name: "i Booster 25", power: "25 dBm", type: "Commercial", coverage: "500 m²", color: "#5B91C4" },
        { name: "i Booster 27", power: "27 dBm", type: "Enterprise", coverage: "1000+ m²", color: "#19AB3F" },
    ...
    },
    {
      ...
      featuredProductLink: "/products/25-dbm",
      products: [
        { name: "i Booster 23", power: "23 dBm", type: "Residential", coverage: "300 m²", color: "#55C45C" },
        { name: "i Booster 25", power: "25 dBm", type: "Commercial", coverage: "500 m²", color: "#5B91C4" },
        { name: "i Booster 27", power: "27 dBm", type: "Enterprise", coverage: "1000+ m²", color: "#19AB3F" },
    ...
    },
    {
      ...
      featuredProductLink: "/products/27-dbm",
      products: [
        { name: "i Booster 23", power: "23 dBm", type: "Residential", coverage: "300 m²", color: "#55C45C" },
        { name: "i Booster 25", power: "25 dBm", type: "Commercial", coverage: "500 m²", color: "#5B91C4" },
        { name: "i Booster 27", power: "27 dBm", type: "Enterprise", coverage: "1000+ m²", color: "#19AB3F" },
  ...
  // Helper to generate product link from power string
  const getProductLink = (power) => {
    const slug = power.toLowerCase().replace(/\s/g, '-'); // "23 dbm" -> "23-dbm"
  ...
  const handleProductCardClick = (power) => {
    navigate(getProductLink(power));
  };

  const handleFeaturedProductClick = (link) => {
    if (link) navigate(link);
  };
    ...
    >
      ...
      <div className="hero-content-wrapper">
        <div className="hero-content-grid">
          ...
          >
            ...
            <div className="hero-specs">
              {slides[currentSlide].specs.map((spec, i) => (
                <div key={i} className="hero-spec-item" style={{ animationDelay: `${i * 0.1}s` }}>
          ...
          >
            {/* Product Showcase — clickable to product page */}
            <div
              ...
              onClick={() => handleFeaturedProductClick(slides[currentSlide].featuredProductLink)}
            >
            ...
            {/* Product Cards — each navigates to its product page */}
            <div className="hero-product-cards">
              {slides[currentSlide].products.map((product, i) => (
                <button
                  ...
                  onClick={() => handleProductCardClick(product.power)}
                  style={{
            ...
            {/* Progress Navigation (slide control) */}
