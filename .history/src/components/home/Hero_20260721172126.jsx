  ...
  const slides = [
    {
      ...
      primaryAction: { type: "route", path: "/contact" },
      secondaryAction: { type: "route", path: "/products" },
      products: [
    ...
    },
    {
      ...
      primaryAction: { type: "route", path: "/products/23dbm" },
      secondaryAction: { type: "download", path: "/datasheets/i-booster-23dbm.pdf" },
      products: [
        { name: "i Booster 23", power: "23 dBm", type: "Residential", coverage: "300 m²", color: "#55C45C" },
        { name: "i Booster 25", power: "25 dBm", type: "Commercial", coverage: "500 m²", color: "#5B91C4" },
        { name: "i Booster 27", power: "27 dBm", type: "Enterprise", coverage: "1000+ m²", color: "#19AB3F" },
    ...
    },
    {
      ...
      primaryAction: { type: "route", path: "/products/25dbm" },
      secondaryAction: { type: "route", path: "/contact" },
      products: [
        { name: "i Booster 23", power: "23 dBm", type: "Residential", coverage: "300 m²", color: "#55C45C" },
        { name: "i Booster 25", power: "25 dBm", type: "Commercial", coverage: "500 m²", color: "#5B91C4" },
        { name: "i Booster 27", power: "27 dBm", type: "Enterprise", coverage: "1000+ m²", color: "#19AB3F" },
    ...
    },
    {
      ...
      primaryAction: { type: "route", path: "/products/27dbm" },
      secondaryAction: { type: "route", path: "/contact" },
      products: [
        { name: "i Booster 23", power: "23 dBm", type: "Residential", coverage: "300 m²", color: "#55C45C" },
        { name: "i Booster 25", power: "25 dBm", type: "Commercial", coverage: "500 m²", color: "#5B91C4" },
    ...
    >
          ...
          >
            ...
            <div className="hero-actions">
              <button
                ...
                onClick={() => handleAction(slides[currentSlide].primaryAction)}
              >
              ...
              <button
                ...
                onClick={() => handleAction(slides[currentSlide].secondaryAction)}
              >
      ...
      <div className="hero-locations-box">
        ...
        <div className="hero-locations-list">
          <span className="hero-location-item">Trivandrum</span>
